...
<div id="about">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <p>
                            Originally founded in Pensacola, FL, the COSMIC Security team has found vulnerabilities in websites to hydroelectric plant software We have spent thousands of hours protecting people, data, and systems. We look forward to the opportunity to do the same for your business.
                    </p>
                </div>
            </div>
        </div>
